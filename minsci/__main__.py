...
def main(args=None):
    ...
    def cvmosaic_callback(args):
        args = vars(args)
        path = args.pop('path')
        jpeg = args.pop('create_jpeg')
        mosey(path, jpeg=jpeg, opencv=True, **args)
    ...
    cvmosaic_parser = subparsers.add_parser(
        'cvmosaic',
        help='Use OpenCV to stitch tiles into a mosaic')
    cvmosaic_parser.add_argument(
        '-p',
        dest = 'path',
        type=str,
    ...
    cvmosaic_parser.set_defaults(func=cvmosaic_callback)
